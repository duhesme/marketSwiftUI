...
internal enum FontFamily {
  internal enum MarkPro {
    internal static let regular = FontConvertible(name: "MarkPro", family: "Mark Pro", path: "Mark-Pro.ttf")
    internal static let bold = FontConvertible(name: "MarkPro-Bold", family: "Mark Pro", path: "Mark-Pro-Bold.ttf")
    internal static let medium = FontConvertible(name: "MarkPro-Medium", family: "Mark Pro", path: "MarkPro-Medium.ttf")
  ...
  internal static let allCustomFonts: [FontConvertible] = [MarkPro.all, SFProDisplay.all].flatMap { $0 }
